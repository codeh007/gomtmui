...
async function init(input) {
  ...
  imports.wbg.__wbg_stack_0ddaca5d1abfb52f = (arg0, arg1) => {
  ...
  imports.wbg.__wbg_error_09919627ac0992f5 = (arg0, arg1) => {
    try {
    ...
    async (evt) => {
      if (evt.data.wasmUrl) {
        ...
        try {
          ...
          const resultData = decode_qoi(data);
          const img = {
